    ...
    <div class="max-w-[1400px] mx-auto px-6">
        ...
        @php
            ...
            $fallbackIcons = [
                ...
                'X' => '<svg class="w-8 h-8 text-black" fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>',
        ...
        @foreach($groupedPosts as $platform => $posts)
        <!-- {{ $platform }} Section -->
        <div class="mb-24">
            <div class="flex items-center justify-between mb-8" data-aos="fade-up">
                <h2 class="text-3xl font-bold tracking-tight text-gray-900 flex items-center gap-3">
                ...
                @php
                    $platformLink = isset($globalSocialLinks['social_media']) 
                        ? $globalSocialLinks['social_media']->firstWhere('platform_name', $platform) 
                        : null;
                @endphp
                @if($platformLink)
