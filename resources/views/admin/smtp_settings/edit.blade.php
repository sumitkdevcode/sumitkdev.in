...
@section('header', 'Edit SMTP Configuration')
...
@section('content')
    <div class="max-w-4xl mx-auto">
        <div class="mb-8">
            ...
            <h1 class="text-2xl lg:text-3xl font-bold tracking-tight mt-4">Edit SMTP Configuration</h1>
        </div>

        <form action="{{ route('admin.smtp-settings.update', $smtpSetting->id) }}" method="POST" class="bg-white border border-gray-100 p-6 lg:p-8 space-y-8 shadow-sm">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="name" id="name" value="{{ old('name', $smtpSetting->name) }}" required
                ...
                <div>
                    ...
                    <input type="text" name="mail_mailer" id="mail_mailer" value="{{ old('mail_mailer', $smtpSetting->mail_mailer) }}" required
                        class="w-full bg-gray-50 border border-gray-200 text-gray-900 text-sm rounded-none focus:ring-black focus:border-black block p-3 transition-colors">
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="mail_host" id="mail_host" value="{{ old('mail_host', $smtpSetting->mail_host) }}" required
                        class="w-full bg-gray-50 border border-gray-200 text-gray-900 text-sm rounded-none focus:ring-black focus:border-black block p-3 transition-colors">
                </div>
                ...
                <div>
                    ...
                    <input type="number" name="mail_port" id="mail_port" value="{{ old('mail_port', $smtpSetting->mail_port) }}" required
                        class="w-full bg-gray-50 border border-gray-200 text-gray-900 text-sm rounded-none focus:ring-black focus:border-black block p-3 transition-colors">
                </div>
                ...
                <div>
                    ...
                    <select name="mail_encryption" id="mail_encryption"
                        ...
                        <option value="tls" {{ old('mail_encryption', $smtpSetting->mail_encryption) == 'tls' ? 'selected' : '' }}>TLS</option>
                        <option value="ssl" {{ old('mail_encryption', $smtpSetting->mail_encryption) == 'ssl' ? 'selected' : '' }}>SSL</option>
                    </select>
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="mail_username" id="mail_username" value="{{ old('mail_username', $smtpSetting->mail_username) }}"
                        class="w-full bg-gray-50 border border-gray-200 text-gray-900 text-sm rounded-none focus:ring-black focus:border-black block p-3 transition-colors">
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="mail_password" id="mail_password" value="{{ old('mail_password', $smtpSetting->mail_password) }}"
                        class="w-full bg-gray-50 border border-gray-200 text-gray-900 text-sm rounded-none focus:ring-black focus:border-black block p-3 transition-colors">
                </div>
                ...
                <div>
                    ...
                    <input type="email" name="mail_from_address" id="mail_from_address" value="{{ old('mail_from_address', $smtpSetting->mail_from_address) }}" required
                        class="w-full bg-gray-50 border border-gray-200 text-gray-900 text-sm rounded-none focus:ring-black focus:border-black block p-3 transition-colors">
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="mail_from_name" id="mail_from_name" value="{{ old('mail_from_name', $smtpSetting->mail_from_name) }}" required
                        class="w-full bg-gray-50 border border-gray-200 text-gray-900 text-sm rounded-none focus:ring-black focus:border-black block p-3 transition-colors">
                </div>
            </div>
