...
@section('header', 'Edit Journal Entry')
...
@section('content')
    <div class="max-w-4xl mx-auto">
        <div class="mb-8 lg:mb-12">
            ...
            <h1 class="text-2xl lg:text-3xl font-bold tracking-tight mt-4">Edit: {{ $blog->title }}</h1>
        </div>
            ...
            <div class="space-y-6 lg:space-y-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                    ...
                    <div class="space-y-2">
                        <label class="text-[9px] lg:text-[10px] uppercase tracking-widest font-bold text-gray-400">Sub
                            Images (Max 5)</label>
                        @if($blog->sub_images && count($blog->sub_images) > 0)
                            <div class="flex flex-wrap gap-2 mb-4">
                                @foreach($blog->sub_images as $image)
                ...
                <div class="space-y-2">
                    ...
                    <textarea name="excerpt" rows="2"
                        ...
                        placeholder="A short hook for the post...">{{ old('excerpt', $blog->excerpt) }}</textarea>
                </div>
                ...
                <div class="space-y-2">
                    ...
                    <textarea name="content" id="editor" rows="15"
                        ...
                        placeholder="Write your article here..." required>{{ old('content', $blog->content) }}</textarea>
                </div>
