...
@section('content')
    <div class="max-w-4xl mx-auto">
        ...
        <form action="{{ route('admin.email-templates.store') }}" method="POST" enctype="multipart/form-data" class="bg-white border border-gray-100 p-6 lg:p-8 space-y-8 shadow-sm">
            @csrf
            ...
            <div class="grid grid-cols-1 gap-6">
                ...
                <!-- Attachments -->
                <div>
                    <label for="attachments" class="block text-xs font-bold text-gray-900 uppercase tracking-widest mb-2">Attachments (Optional)</label>
