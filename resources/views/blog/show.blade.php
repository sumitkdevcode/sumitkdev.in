...
@section('content')
    ...
    <article class="pb-32">
        ...
        <section class="max-w-7xl mx-auto px-6 mb-16 pt-8">
            <div class="relative w-full aspect-[4/5] sm:aspect-video md:aspect-[3/1] bg-gray-900 group neo-frame overflow-hidden">
                        ...
                        <div class="pt-20 border-t border-black/5 flex flex-col md:flex-row justify-between items-center gap-8">
                            ...
                            <div class="flex items-center space-x-4">
                                ...
                                <a href="https://twitter.com/intent/tweet?text={{ urlencode($post->title) }}&url={{ urlencode(url()->current()) }}&via=sumitkdevs"
                                    ...
                                    class="w-10 h-10 border-2 border-black/10 flex items-center justify-center hover:bg-black hover:text-white hover:border-black transition-all neo-frame-small">
                                ...
                                <button onclick="copyPostLink()" title="Copy link"
                                    class="w-10 h-10 border-2 border-black/10 flex items-center justify-center hover:bg-black hover:text-white hover:border-black transition-all relative neo-frame-small" id="copyLinkBtn">
    ...
    <!-- Author Bio Card -->
    <section class="py-20 border-t border-black/5 bg-white relative">
        <!-- Inner background pattern just for the bio area -->
        <div class="absolute inset-0 bg-grid-pattern opacity-10 pointer-events-none z-0"></div>
        <div class="max-w-3xl mx-auto px-6 relative z-10">
            <div class="bg-white neo-frame p-8 md:p-12 flex flex-col md:flex-row gap-8 items-start border-2 border-black/10 hover:border-black transition-colors" data-aos="fade-up">
                <div class="w-16 h-16 bg-black text-white flex items-center justify-center text-2xl font-bold flex-shrink-0 neo-frame-small">
                    S
                </div>
                <div class="flex-1">
                    <h3 class="text-xl font-bold uppercase tracking-wider mb-2">Written by Sumit Kumar</h3>
                    ...
                    <div class="flex flex-wrap gap-4">
                        <a href="{{ route('about') }}" class="text-[10px] uppercase font-bold tracking-widest border-b-2 border-black pb-1 hover:text-gray-500 transition-colors">My Story</a>
                        <a href="{{ route('portfolio.index') }}" class="text-[10px] uppercase font-bold tracking-widest border-b-2 border-black pb-1 hover:text-gray-500 transition-colors">Portfolio</a>
                        <a href="{{ route('links') }}" class="text-[10px] uppercase font-bold tracking-widest border-b-2 border-black pb-1 hover:text-gray-500 transition-colors">All Profiles</a>
                        <a href="{{ route('contact') }}" class="text-[10px] uppercase font-bold tracking-widest border-b-2 border-black pb-1 hover:text-gray-500 transition-colors">Hire Me</a>
                    </div>
                </div>
            </div>
        </div>
