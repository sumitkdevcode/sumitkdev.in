...
<div class="bg-white min-h-[70vh]">
    <div class="max-w-[1000px] mx-auto px-6 py-20 lg:py-32">
        ...
        <div class="prose prose-lg max-w-none" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="mt-8">
                <a href="https://github.com/sumitkdevcode/sumitkdev.in" target="_blank" rel="noopener noreferrer" class="inline-flex items-center justify-center px-8 py-4 border-2 border-black bg-black text-white hover:bg-white hover:text-black transition-all text-sm font-bold uppercase tracking-widest no-underline">
