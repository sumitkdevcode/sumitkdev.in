    ...
    public function run()
    {
        $pages = [
            [
                ...
                'meta_description' => 'Sumit Kumar is a Full Stack Developer & Software Engineer specializing in Laravel, React, Vue.js, and modern web technologies. Explore portfolio, read 500+ tutorials, and hire for projects.',
                ...
                'og_title' => 'Sumit Kumar — Full Stack Developer & Software Engineer',
                'og_description' => 'Official website of Sumit Kumar. Explore portfolio, read technical tutorials, and hire me for your next project.',
            ...
            [
                ...
                'meta_description' => 'Learn about Sumit Kumar — MCA graduate, Software Engineer at Web IT Squad. 3+ years of experience in Laravel, React, ASP.NET Core, and modern web development.',
            ...
            [
                ...
                'meta_description' => 'Showcase of web development projects by Sumit Kumar. Client work, open-source contributions, and technical case studies using Laravel, React, and ASP.NET Core.',
                'meta_keywords' => 'Sumit Kumar Portfolio, sumitkdev Projects, Web Development, Laravel Projects, Open Source',
                'og_title' => 'Portfolio — Sumit Kumar',
            ...
            [
                ...
                'meta_description' => '500+ tutorials, tips, and insights on PHP, Laravel, JavaScript, React, and software engineering by Sumit Kumar. Learn modern web development.',
                'meta_keywords' => 'sumitkdev Blog, Sumit Kumar Tutorials, Laravel Tips, React Developer Blog, Web Development Articles',
                'og_title' => 'Developer Blog — Sumit Kumar',
            ...
            [
                ...
                'meta_description' => 'Get in touch with Sumit Kumar for freelance web development, full-time opportunities, or project consultation. Based in Greater Noida, India.',
            ...
            [
                ...
                'meta_description' => 'Explore open-source packages, GitHub repositories, and community contributions by Sumit Kumar in the Laravel and PHP ecosystem.',
                'meta_keywords' => 'Open Source Projects, GitHub sumitkdev, sumitkdevcode, Laravel Packages, Free Code',
                'og_title' => 'Open Source — Sumit Kumar',
            ...
            [
                'page_path' => '/links',
                'page_name' => 'All Links',
                'meta_title' => 'Sumit Kumar — All Links & Socials',
                'meta_description' => 'Find all of Sumit Kumar\'s social media profiles, recent articles, and important resources in one place.',
            ...
            [
                ...
                'meta_description' => 'A visual tour of Sumit Kumar\'s workspace, developer setup, and behind-the-scenes moments.',
            ...
            [
                ...
                'meta_title' => 'Social Feed & YouTube — Sumit Kumar',
                'meta_description' => 'Catch up on Sumit Kumar\'s latest YouTube tutorials, Instagram moments, and professional posts. All social updates in one place.',
            ...
            [
                'page_path' => '/resume',
                'page_name' => 'Resume',
                'meta_title' => 'Resume & CV — Sumit Kumar',
                'meta_description' => 'Professional resume and CV of Sumit Kumar, a Full Stack Developer specializing in Laravel, React, ASP.NET Core, and modern web technologies.',
                'meta_keywords' => 'Sumit Kumar Resume, sumitkdev CV, Full Stack Developer Resume, Laravel Developer CV, Hire Web Developer',
                'og_title' => 'Resume — Sumit Kumar',
